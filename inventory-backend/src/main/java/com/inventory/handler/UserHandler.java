...
public class UserHandler {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("=== Testing UserHandler ===\n");
        ...
        User newUser = new User("testuser", "test123", "Cashier");
        boolean registered = handler.registerUser(newUser);
        System.out.println(registered ? "✓ User registered: " + newUser : "✗ Registration failed");

        // Test 4: Get user by ID
        if (newUser.getUserId() > 0) {
            System.out.println("\n4. Getting user by ID " + newUser.getUserId() + ":");
            User fetchedUser = handler.getUserById(newUser.getUserId());
            System.out.println(fetchedUser);

            // Test 5: Update user
            System.out.println("\n5. Updating user:");
            fetchedUser.setRole("Stock Manager");
            boolean updated = handler.updateUser(fetchedUser);
